...
async def buy_options_kb():
    ...
    kb.row(
        InlineKeyboardButton(text='Отзывы', url='https://t.me/sudoteach'),
        InlineKeyboardButton(text='Помощь', url='https://t.me/sudoteach'),
        InlineKeyboardButton(text='TG Канал', url='https://t.me/sudoteach')
    )
